...
SET SEARCH_PATH TO hr, postgres, public;
...
-- Criando comentários --
COMMENT ON TABLE cargos IS 'Tabela de cargos e sua faixa salarial';
COMMENT ON COLUMN cargos.cargo IS 'Nome do cargo';
COMMENT ON COLUMN cargos.salario_minimo IS 'Salário minimo recebido por aquele cargo';
COMMENT ON COLUMN cargos.salario_maximo IS 'Salário máximo recebido por aquele cargo';

COMMENT ON TABLE regioes IS 'Tabela com a lista de regiões';
COMMENT ON COLUMN regioes.id_regiao IS 'Código referente as regiões';
COMMENT ON COLUMN regioes.nome IS 'Nome da região';

COMMENT ON TABLE paises IS 'Tabela de países das localizações de cada funcionário.';
COMMENT ON COLUMN paises.id_pais IS 'Código referente aos países';
COMMENT ON COLUMN paises.nome IS 'Nome do país';
COMMENT ON COLUMN paises.id_regiao IS 'Código referente as regiões';

COMMENT ON TABLE localizacoes IS 'Tabela com a localização dos empregados.';
COMMENT ON COLUMN localizacoes.id_localizacao IS 'Chave primária';
COMMENT ON COLUMN localizacoes.endereco IS 'Endereço residencial';
COMMENT ON COLUMN localizacoes.cep IS 'Endereço postal';
COMMENT ON COLUMN localizacoes.cidade IS 'Cidade do empregado';
COMMENT ON COLUMN localizacoes.uf IS 'Estado em que reside';
COMMENT ON COLUMN localizacoes.id_pais IS 'Código referente aos países';

COMMENT ON TABLE departamentos IS 'Tabela de departamentos da empresa.';
COMMENT ON COLUMN departamentos.id_departamento IS 'Código referente ao departamento';
COMMENT ON COLUMN departamentos.nome IS 'Nome do departamento';
COMMENT ON COLUMN departamentos.id_localizacao IS 'Código referente a localização';
COMMENT ON COLUMN departamentos.id_gerente IS 'Código referente ao gerente';

COMMENT ON TABLE empregados IS 'Tabela com empregados e seus dados pessoais';
COMMENT ON COLUMN empregados.id_empregado IS 'Código referente ao empregado';
...
COMMENT ON COLUMN empregados.comissao IS 'Comissão ganha pelo empregado';
COMMENT ON COLUMN empregados.id_cargo IS 'Código referente ao cargo';
COMMENT ON COLUMN empregados.id_departamento IS 'Código referente ao departamento';

COMMENT ON TABLE historico_cargos IS 'Tabela que armazena o histórico de cargos de um empregado.';
COMMENT ON COLUMN historico_cargos.id_empregado IS 'Código referente ao empregado';
COMMENT ON COLUMN historico_cargos.data_inicial IS 'Data de inicio do empregado no cargo';
COMMENT ON COLUMN historico_cargos.data_final IS 'Data de término do empregado no cargo';
COMMENT ON COLUMN historico_cargos.id_cargo IS 'Código referente ao cargo';
COMMENT ON COLUMN historico_cargos.id_departamento IS 'Código referente ao departamento do cargo';
