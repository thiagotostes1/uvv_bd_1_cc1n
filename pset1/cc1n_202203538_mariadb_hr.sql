...
ALTER TABLE regioes ADD PRIMARY KEY (id_regiao);

ALTER TABLE paises ADD PRIMARY KEY (id_pais);

ALTER TABLE localizacoes ADD PRIMARY KEY (id_localizacao);

ALTER TABLE departamentos ADD PRIMARY KEY (id_departamento);

ALTER TABLE empregados ADD PRIMARY KEY (id_empregado);

ALTER TABLE historico_cargos ADD PRIMARY KEY (id_empregado);

ALTER table paises ADD CONSTRAINT regioes_paises_pfk foreign key(id_regiao) references regioes(id_regiao); 
-- Criando chaves unique --
...
-- Criando comentários -- 
ALTER TABLE cargos COMMENT 'Tabela de cargos e sua faixa salarial';
ALTER TABLE cargos MODIFY COLUMN cargo VARCHAR(35) COMMENT 'Nome do cargo';
ALTER TABLE cargos MODIFY COLUMN salario_minimo DECIMAL(8, 2) COMMENT 'Salário minimo recebido por aquele cargo';
ALTER TABLE cargos MODIFY COLUMN salario_maximo DECIMAL(8, 2) COMMENT 'Salário máximo recebido por aquele cargo';

ALTER TABLE regioes COMMENT 'Tabela com a lista de regiões';
ALTER TABLE regioes MODIFY COLUMN id_regiao INTEGER COMMENT 'Código referente as regiões';
ALTER TABLE regioes MODIFY COLUMN nome VARCHAR(25) COMMENT 'Nome da região';

ALTER TABLE paises COMMENT 'Tabela de países das localizações de cada funcionário.';
ALTER TABLE paises MODIFY COLUMN id_pais CHAR(2) COMMENT 'Código referente aos países';
ALTER TABLE paises MODIFY COLUMN nome VARCHAR(50) COMMENT 'Nome do país';
ALTER TABLE paises MODIFY COLUMN id_regiao INTEGER COMMENT 'Código referente as regiões';

ALTER TABLE localizacoes COMMENT 'Tabela com a localização dos empregados.';
ALTER TABLE localizacoes MODIFY COLUMN id_localizacao INTEGER COMMENT 'Chave primária';
ALTER TABLE localizacoes MODIFY COLUMN endereco VARCHAR(50) COMMENT 'Endereço residencial';
ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'Endereço postal';
ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Cidade do empregado';
ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Estado em que reside';
ALTER TABLE localizacoes MODIFY COLUMN id_pais CHAR(2) COMMENT 'Código referente aos países';

ALTER TABLE empregados COMMENT 'Tabela com empregados e seus dados pessoais';
ALTER TABLE empregados MODIFY COLUMN id_empregado INTEGER COMMENT 'Código referente ao empregado';
...
ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Código referente ao cargo';
ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Salário mensal do empregado';
ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Comissão ganha pelo empregado';
ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Data de contratação do empregado';
ALTER TABLE empregados MODIFY COLUMN id_departamento INTEGER COMMENT 'Código referente ao departamento';

ALTER TABLE historico_cargos COMMENT 'Tabela que armazena o histórico de cargos de um empregado.';
ALTER TABLE historico_cargos MODIFY COLUMN id_empregado INTEGER COMMENT 'Código referente ao empregado';
ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'Data de inicio do empregado no cargo';
ALTER TABLE historico_cargos MODIFY COLUMN data_final DATE COMMENT 'Data de término do empregado no cargo';
ALTER TABLE historico_cargos MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Código referente ao cargo';
ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'Código referente ao departamento do cargo';

-- Inserindo dados tabela regiões --
...
-- Inserindo dados tabela localizações --
...
-- Inserindo dados tabela departamentos --
...
-- Inserindo dados tabela histórico cargos --
...
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) VALUES 
(177, '2007-01-01', '2007-12-31', 'SA_MAN', 80);
INSERT INTO historico_cargos (id_empregado, data_inicial, data_final, id_cargo, id_departamento) VALUES 
(203, '2002-07-01', '2006-12-31', 'AC_ACCOUNT', 90);
